...
- Name: LoginToApplication.spec.js >> testing page object model
- Location: tests\LoginToApplication.spec.js:4:1
...
```ts
  ...
  3  |     constructor(page){
  4  |         this.page=page
> 5  |         this.username("#email1")
     |              ^ TypeError: this.username is not a function
  6  |         this.password("#password1")
  7  |         this.login("//button[@type='submit']")
  8  |     }
  9  | 
  10 |     async LoginToApplication(){
  11 |         await this.page.fill(this.username,"admin@email.com")
  12 |         await this.page.fill(this.password,"admin@123")
  13 |         await this.page.click(this.login)
  14 |     }
  15 | }
  16 | 
